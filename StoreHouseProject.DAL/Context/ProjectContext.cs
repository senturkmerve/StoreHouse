...
using StoreHouseProject.Map.Option;
...
namespace StoreHouseProject.DAL.Context
{
    public class ProjectContext : DbContext
    {
        public ProjectContext()
        {
            Database.Connection.ConnectionString = "Server=DESKTOP-360Q214\\SQLSERVER2017EXP;Database=NTier;uid=mrv;pwd=123456;";
        }
